...
class DupireLocalVolSurface:
    ...
    def cubic_splines_of_option_price_with_respect_to_maturity(self, strike: float) -> tuple[CubicSpline, CubicSpline]:
    ...
    def cubic_splines_of_option_price_with_respect_to_strike(self, expire_date: datetime) -> tuple[CubicSpline, CubicSpline]:
